...
loadScript("../../../"+module+"/"+folder+"/media/fibhostacitivity.js");*/


var FibActivityHostSlide = function(_xmlData,_dataObject)
{		
	this.initiateComp(_xmlData,_dataObject);	
	var dtoc = new fibhostacitivity(_xmlData);
	
}

var _this = FibActivityHostSlide.prototype;
...
if(_dataObject.texts == "undefined") return;
	...
	compId = _dataObject.texts[0].compId;
