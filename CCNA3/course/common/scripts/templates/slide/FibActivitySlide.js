...
loadScript("../../../"+module+"/"+folder+"/media/fibacitivity.js");*/


var FibActivitySlide = function(_xmlData,_dataObject)
{		
	this.initiateComp(_xmlData,_dataObject);	
	var dtoc = new fibacitivity(_xmlData);
	
}

var _this = FibActivitySlide.prototype;
