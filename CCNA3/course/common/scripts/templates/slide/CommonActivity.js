...
loadScript("../../../"+module+"/"+folder+"/media/activity.js");


var NetWorkActvitySlide = function(_xmlData,_dataObject)
{		
	this.initiateComp(_xmlData,_dataObject);	
	var nwactivity = new NwActivity(_xmlData);
}

var _this = NetWorkActvitySlide.prototype;
