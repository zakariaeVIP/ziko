...
loadScript("../../../"+module+"/"+folder+"/media/animactivity.js");


var AnimationActivitySlide = function(_xmlData,_dataObject)
{		
	this.initiateComp(_xmlData,_dataObject);	
	var dtoc = new animactivity(_xmlData);
}

var _this = AnimationActivitySlide.prototype;
