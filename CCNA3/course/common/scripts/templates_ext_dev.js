...
(SyntaxComp = function (o) {
	...
	a.style.cssText = "top:0px;left:-10px;padding-left:2px;visibility:hidden;overflow:auto;background-color:#000;color:#fff;white-space:pre-wrap;font-size:"+o.size+"px;width:"+(o.width-18)+"px;height:"+(o.height-73)+"px;";	
...
(McTable = function (o, xmlNode) {
   ...
   'box-shadow': '2px 2px 5px #393536'
	...
	t.createButton = function(_w,_h,_p,_k){
		...
		img.graphics.beginBitmapFill(imageObject.dot,"no-repeat").drawRect(0,0,18,18);
