...
(lib.LSA5 = function() {
	...
	// Layer 3
    this.text_2 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt05", width:"100", expand:"up+down", size:"9"}); 	
	this.text_2.setTransform(40,8);
...
(lib.LSA4 = function() {
	...
	// Layer 3
	this.text_3 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt03", width:"100", expand:"up+down", size:"9"}); 	
	this.text_3.setTransform(40,8);
...
(lib.LSA3 = function() {
	...
	// Layer 2
		this.text_4 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt04", width:"100", expand:"up+down", size:"9"}); 	
	this.text_4.setTransform(40,8);
...
(lib.LSA2 = function() {
	...
	// Layer 3
	this.text_6 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt02", width:"100", expand:"up+down", size:"9"}); 	
	this.text_6.setTransform(40,8);
...
(lib.LSA1 = function() {
	...
	// text
	this.text_8 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt01", width:"100", expand:"up+down", size:"9"}); 	
	this.text_8.setTransform(40,8);
