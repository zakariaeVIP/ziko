...
(slideViewDidLoad = function(slideContainer){
	...
	//purple component 	
	var fbComp = getCJSElement("TEXTBOX",{subType:"CLOSABLE", x:"1",y:"162",width:"265",height:"180",titleId:"txt_correct",bodyId:"txt_body_correct",visible:"0"});
	...
	//adding text field 
	$("#commonMediaText").append('<input id = "decimal" maxlength="19" style="background-color: #66C0E5; border:1px solid #FFFFFF; font-size:11px; text-align:center; width:164px; left:60px; top:-5px; height:16px; "/>');	
...
//adding text field 
	$("#commonMediaText").append('<input id = "wildcard" maxlength="19" style="background-color: #66C0E5; border:1px solid #FFFFFF; font-size:11px; text-align:center; width:164px; left:60px; top:7px; height:16px;"/>');	
