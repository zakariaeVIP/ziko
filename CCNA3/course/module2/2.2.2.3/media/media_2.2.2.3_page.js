...
(slideViewDidLoad = function(_container,_id)
{
	...
	if(_id > 0)
	{
		...
		rh.x = 115;
		rh.y = 290;
		var bb_chk = getCJSElement("BLUE_BUTTON",{x:495,y:373.8,width:100,height:21,size:12,id:("bb_chk"+parseInt(_id)),compId:"ID_s"+parseInt(_id)+"_check",callback:checkAns});
		var bb_rst = getCJSElement("BLUE_BUTTON",{x:625,y:373.8,width:100,height:21,id:"bb_rst"+parseInt(_id),compId:"ID_s"+parseInt(_id)+"_reset",callback:reset});
		...
		var feedback = getCJSElement("TEXTBOX",{subType:"CLOSABLE",x:"205",y:"100",width:"228.4",height:"167",titleId:"ID_blankTitle",bodyId:"ID_blankBody",visible:"0"});
