...
(lib.ID_txt09 = function() {
	...
	// txt
		this.text = new DOMObject({type:"TEXT",compId:"ID_txt09",width:"34.2",expand:"down",align:"center",color:"#FFFFFF",size:"9"});
...
(lib.ID_txt08 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt08",width:"53.4",expand:"down",align:"center",color:"#FFFFFF",size:"9"});
...
(lib.ID_txt07 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt07",width:"57.2",expand:"down",align:"center",color:"#FFFFFF",size:"9"});
...
(lib.ID_txt06 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt06",width:"31.65",expand:"down",align:"center",color:"#FFFFFF",size:"9"});	
...
(lib.ID_txt05 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt05",width:"52.85",expand:"down",align:"center",color:"#FFFFFF",size:"9"});
...
(lib.ID_txt04 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt04",width:"57.2",expand:"down",align:"center",color:"#FFFFFF",size:"9"});
...
(lib.ID_txt03 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt03",width:"32.95",expand:"down",align:"center",color:"#FFFFFF",size:"9"});
...
(lib.ID_txt02 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt02",width:"52.75",expand:"down",align:"center",color:"#FFFFFF",size:"9"});
...
(lib.ID_txt01 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt01",width:"52.75",expand:"down",align:"center",color:"#FFFFFF",size:"9"});
...
(lib.txtboxMc = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt20",width:"52.70",expand:"left+right",align:"center",size:"8"});
...
(lib.EnvelopeStatic6 = function() {
	...
	// label
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt15",width:"48",expand:"up+down",align:"center",size:"8"});	
...
(lib.EnvelopeStatic5 = function() {
	...
	// label
	 this.text = new DOMObject({type:"TEXT",compId:"ID_txt14",width:"48",expand:"up+down",align:"center",size:"8"});
	this.text.setTransform(-25.6,-7.4);
...
(lib.EnvelopeStatic4 = function() {
	...
	// label
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt13",width:"48",expand:"up+down",align:"center",size:"8"});
...
(lib.EnvelopeStatic3 = function() {
	...
	// label
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt12",width:"48",expand:"up+down",align:"center",size:"8"});
	this.text.setTransform(-25.6,-7.4);
...
(lib.EnvelopeStatic2 = function() {
	...
	// label
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt11",width:"48",expand:"up+down",align:"center",size:"8"});
...
(lib.EnvelopeStatic = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt10",width:"48",expand:"up+down",align:"center",size:"8"});
	this.text.setTransform(-25.6,-7.4);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1050).to({alpha:1,mode:"synched",startPosition:0},0).to({scaleX:1,scaleY:1.03,x:409.3,y:141.3},15).wait(5).to({startPosition:0},0).to({y:308.3},18).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(976).to({alpha:1},0).to({scaleX:0.97,scaleY:1.05,x:360.1,y:141.3},15).wait(5).to({startPosition:0},0).to({x:354,y:308.3},23).wait(83));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(916).to({alpha:1},0).to({scaleX:.98,scaleY:1.05,x:96,y:139.3},16).wait(7).to({startPosition:0},0).to({y:308.3},16).wait(147));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(10).to({x:275.8,alpha:1},20).wait(737).to({x:274.2},0).to({x:378.2},10).wait(311).to({scaleX:0.66,scaleY:0.66,alpha:0},13).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_35).wait(10).to({x:202.7,alpha:1},20).wait(737).to({x:90.7},10).wait(169).to({scaleX:0.88,scaleY:0.88,x:92.2},0).to({alpha:0},22).wait(134));
	...
	this.instance_39.setTransform(87.5,190,1,1,0,0,0,26.4,8.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_39}]}).wait(1102));

	// ID_txt03
	this.instance_40 = new lib.ID_txt03();
	this.instance_40.setTransform(131,190,1,1,0,0,0,16.4,8.5);
	...
	this.text_10.setTransform(230.5,300.7);
	...
	this.text_30.setTransform(404.1,70.8);
	...
	this.text_33.setTransform(318,79.6);
	...
	this.text_35.setTransform(173.6,79.6);

	this.text_36 =  new DOMObject({type:"TEXT",text:"Fa0/0", color:"#393536"});
	this.text_36.setTransform(31.1,70.8);
	...
	// bg
	this.instance_47 = new lib._5214();
