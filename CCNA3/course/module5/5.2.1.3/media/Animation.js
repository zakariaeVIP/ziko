...
(lib.t3_r43h2 = function() {
	...
	// Layer 2
	//this.text = new DOMObject({type:"TEXT",text:"1",size:"9"});
	this.text = new cjs.Text("1", "10px Arial", "#393536");
	this.text.textAlign = "center";
	this.text.lineHeight = 12;
	this.text.setTransform(13.1,7);
...
(lib._zero_lt_bg = function() {
	...
	// Layer 2
	this.text_1 = new DOMObject({type:"TEXT",text:"0",size:"9"});
...
(lib._zero = function() {
	...
	// Layer 2
	this.text_2 = new DOMObject({type:"TEXT",text:"0",size:"9"});
...
(lib._S0_0_1_lt_bg = function() {
	...
	// Layer 2
	this.text_3 = new DOMObject({type:"TEXT",text:"S0/0/1",size:"9"});
...
(lib._S0_0_1 = function() {
	...
	// Layer 2
	this.text_4 = new DOMObject({type:"TEXT",text:"S0/0/1",size:"9"});
	//this.text_4 = new cjs.Text("S0/0/1", "10px Arial", "#393536");
	//this.text_4.textAlign = "center";
	//this.text_4.lineHeight = 12;
	this.text_4.setTransform(15,10);
...
(lib._S0_0_0 = function() {
	...
	// Layer 2
	this.text_5 = new DOMObject({type:"TEXT",text:"S0/0/0",size:"9"});
	//this.text_5 = new cjs.Text("S0/0/0", "10px Arial", "#393536");
	//this.text_5.textAlign = "center";
	//this.text_5.lineHeight = 12;
	this.text_5.setTransform(10,9);
...
(lib._one_hilite = function() {
	...
	// Layer 2
	this.text_6 = new DOMObject({type:"TEXT",text:"1",size:"9"});
...
(lib._one = function() {
	...
	// Layer 2
	this.text_7 = new DOMObject({type:"TEXT",text:"1",size:"9"});
...
(lib._10400_lt_bg = function() {
	...
	// Layer 2
	this.text_8 = new DOMObject({type:"TEXT",text:"10.4.0.0",size:"9"});
...
(lib._10300_lt_bg = function() {
	...
	// Layer 2
	this.text_9 = new DOMObject({type:"TEXT",text:"10.3.0.0",size:"9"});
	//this.text_9 = new cjs.Text("10.3.0.0", "10px Arial", "#393536");
	//this.text_9.textAlign = "center";
	//this.text_9.lineHeight = 12;
	this.text_9.setTransform(5,7);
...
(lib._10300 = function() {
	...
	// Layer 2
	this.text_10 = new DOMObject({type:"TEXT",text:"10.3.0.0",size:"9"});
	//this.text_10 = new cjs.Text("10.3.0.0", "10px Arial", "#393536");
	//this.text_10.textAlign = "center";
	//this.text_10.lineHeight = 12;
	this.text_10.setTransform(-2,10);
...
(lib._10200_lt_bg = function() {
	...
	// Layer 2
	this.text_11 = new DOMObject({type:"TEXT",text:"10.2.0.0",size:"9"});
	//this.text_11 = new cjs.Text("10.2.0.0", "10px Arial", "#393536");
	//this.text_11.textAlign = "center";
	//this.text_11.lineHeight = 12;
	this.text_11.setTransform(-2,7);
...
(lib.h33 = function() {
	...
	// Layer 1
		this.text_17 = new DOMObject({type:"TEXT",compId:"ID_txt09",width:"36",expand:"down",align:"center",color:"#ffffff",size:"9"});

		this.text_17.setTransform(-2,10);
...
(lib.h32 = function() {
	...
	// Layer 1
	this.text_18 = new DOMObject({type:"TEXT",compId:"ID_txt08",width:"45",expand:"down",align:"center",color:"#ffffff",size:"9"});
	this.text_18.setTransform(1,10);
...
(lib.h31 = function() {
	...
	// Layer 1
			this.text_19 = new DOMObject({type:"TEXT",compId:"ID_txt07",width:"60",expand:"down",align:"center",color:"#ffffff",size:"9"});
	
	this.text_19.setTransform(-1,10);
...
(lib.h23 = function() {
	...
	// Layer 1
		this.text_20 = new DOMObject({type:"TEXT",compId:"ID_txt06",width:"36",expand:"down",align:"center",color:"#ffffff",size:"9"});

	this.text_20.setTransform(-2,10);
...
(lib.h22 = function() {
	...
	// Layer 1
		this.text_21 = new DOMObject({type:"TEXT",compId:"ID_txt05",width:"45",expand:"down",align:"center",color:"#ffffff",size:"9"});
	this.text_21.setTransform(1,10);
...
(lib.h21 = function() {
	...
	// Layer 1
	this.text_22 = new DOMObject({type:"TEXT",compId:"ID_txt04",width:"60",expand:"down",align:"center",color:"#ffffff",size:"9"});
	this.text_22.setTransform(-1,-8);
...
(lib.h13 = function() {
	...
	// Layer 1
		this.text_23 = new DOMObject({type:"TEXT",compId:"ID_txt03",width:"36",expand:"down",align:"center",color:"#ffffff",size:"9"});
		this.text_23.setTransform(-2,10);
...
(lib.h12 = function() {
	...
	// Layer 1
	this.text_24 = new DOMObject({type:"TEXT",compId:"ID_txt02",width:"45",expand:"down",align:"center",color:"#ffffff",size:"9"});
	this.text_24.setTransform(2,10);
...
(lib.h11 = function() {
	...
	// Layer 2
		this.text_25 = new DOMObject({type:"TEXT",compId:"ID_txt01",width:"60",expand:"down",align:"center",color:"#ffffff",size:"9"});
		this.text_25.setTransform(-1,10);
...
(lib.EnvelopeStatic6 = function() {
	...
	// label
	this.text_26 = new DOMObject({type:"TEXT",compId:"ID_txt15",width:"51.8",expand:"up+down",align:"center",size:"9"});
...
(lib.EnvelopeStatic4copy = function() {
	...
	// label
	this.text_27  = new DOMObject({type:"TEXT",compId:"ID_txt14",width:"51.8",expand:"up+down",align:"center",size:"9"});
...
(lib.EnvelopeStatic4 = function() {
	...
	// label
		this.text_28 = new DOMObject({type:"TEXT",compId:"ID_txt13",width:"51.8",expand:"up+down",align:"center",size:"9"});
...
(lib.EnvelopeStatic3 = function() {
	...
	// label
	this.text_29 = new DOMObject({type:"TEXT",compId:"ID_txt12",width:"51.8",expand:"up+down",align:"center",size:"9"});
...
(lib.EnvelopeStatic2 = function() {
	...
	// label
	this.text_30 = new DOMObject({type:"TEXT",compId:"ID_txt11",width:"51.8",expand:"up+down",align:"center",size:"9"});
...
(lib.EnvelopeStatic = function() {
	...
	// label
	this.text_31 = new DOMObject({type:"TEXT",compId:"ID_txt10",width:"51.8",expand:"up+down",align:"center",size:"9"});
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.instance_40.setTransform(90.1,90,0.618,0.618,0,0,0,27.5,13.8);
	this.instance_40.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_40).wait(753).to({startPosition:0},0).to({alpha:1},9).wait(12).to({startPosition:0},0).to({scaleX:1,scaleY:1,x:92.5,y:140.8},12).wait(9).to({startPosition:0},0).to({regX:27.7,regY:13.9,x:92.7,y:279.9},17).wait(498));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_50).wait(924).to({startPosition:0},0).to({alpha:1},10).wait(8).to({startPosition:0},0).to({scaleX:1,scaleY:1,x:241.5,y:141.8},16).wait(13).to({startPosition:0},0).to({x:249.5,y:279.9},15).wait(324));
