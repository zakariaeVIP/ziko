...
(lib.ID_txt07 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt07",width:"460.05",expand:"down",align:"center",size:"10"});	
...
(lib.ID_txt04 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt04",width:"134",expand:"down",align:"center",class:"lazybgCallOut",size:"10"});	
	this.addChild(this.text);
}).prototype = p = new cjs.Container();
...
(lib.ID_txt03 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt03",width:"115",expand:"left",align:"center",class:"lazybgCallOut",size:"10"});
	this.addChild(this.text);
}).prototype = p = new cjs.Container();
...
(lib.ID_txt02 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt02",width:"104",expand:"down",align:"center",class:"lazybgCallOut",size:"10"});		
...
(lib.ID_txt01 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt01",width:"115",expand:"right",align:"center",class:"lazybgCallOut",size:"10"});
	this.addChild(this.text);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,104,15.2);
...
(lib.RedX_1 = function() {
	...
	this.instance.setTransform(-18.3,-37,0.497,0.502);
...
(lib.envelopeclosedstatic = function() {
	...
	this.instance.setTransform(-49,-46.1,0.75,0.7);
...
(lib.EnvelopeStatic3 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt06",width:"65.7",expand:"up+down",align:"center",size:"10"});	
	this.text.setTransform(8,8);
...
(lib.EnvelopeStatic = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt05",width:"65.7",expand:"up+down",align:"center",size:"10"});	
	this.text.setTransform(8,8);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_5.setTransform(208,213.6,1,1,0,0,0,52,14.5);
