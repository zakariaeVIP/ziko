...
;(function($) { 
   ...
   var dd = function(element, options, aDefaultTitleImgPath)
   {
		...
		var styles = {dd:options.mainCSS, ddTitle:'ddTitle', arrow:'arrow', ddChild:'ddChild', ddTitleText:'ddTitleText', disabled:.90, ddOutOfVision:'ddOutOfVision', borderTop:'borderTop', noBorderTop:'noBorderTop', selected:'selected'};
	...
	var resetTitleDiv = function() {	
		...
		document.getElementById(titletextid).innerHTML = lTitleInnerHTML;			
	};
