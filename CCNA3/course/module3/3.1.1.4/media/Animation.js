...
(lib.greenbubble2 = function() {
	...
	// Layer 1
	this.text = new DOMObject({type:"TEXT",compId:"ID_s1_txt09",width:"111",expand:"up",align:"left",color:"#393536",class:"greenCallOut"});
...
(lib.greenbubble1 = function() {
	...
	// Layer 1
	this.text = new DOMObject({type:"TEXT",compId:"ID_s1_txt08",width:"111",expand:"up",align:"left",color:"#393536",class:"greenCallOut"});
	this.text.setTransform(1,-8);
